module.exports = {
  ...
  'courses.practical.you.label':     'Vous apportez',
  'courses.practical.you.text':      "deux fois la même figurine, une pour vous et une pour moi, vos pinceaux et vos outils habituels, et un plan de travail correctement éclairé. Pour une unité, un second modèle dans une pose différente convient très bien, et vous gardez les deux pièces à la fin.",
  'courses.practical.me.label':      'J’apporte',
  'courses.practical.me.text':       "les peintures, prêtées le temps de la séance et que je remporte ensuite, ainsi qu’une fiche des couleurs et des étapes vues ensemble.",
  'courses.practical.know.label':    'Bon à savoir',
  'courses.practical.know.text':     "l’enseignement se fait au pinceau, à l’aérographe seulement si vous en possédez déjà un. La réservation passe par le formulaire de contact avec un acompte de 30 %, et l’annulation est gratuite jusqu’à une semaine avant la date. Le cours se donne en français ou en anglais.",
