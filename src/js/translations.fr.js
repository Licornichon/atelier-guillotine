module.exports = {
  ...
  'faq.q1.answer': "Chaque projet commence par une discussion. Vous me décrivez vos figurines et le rendu que vous visez, je vous propose un devis détaillé. Une fois validé, je réalise la peinture et vous tiens informé de l’avancement tout au long du projet.",
  ...
  'faq.q3.answer': "Chaque projet est différent. Une grande armée au schéma simple fait baisser le coût par figurine, alors qu’une pièce détaillée ou de niveau Display demande beaucoup plus de temps de pinceau.",
  'faq.q4.title': 'Quels sont les délais de réalisation ?',
  'faq.q4.answer': "Les délais dépendent de l’ampleur du projet et de la charge de travail en cours. Si vous avez une échéance précise (tournoi ou événement), merci de me le préciser afin de confirmer ce qui est réalisable.",
