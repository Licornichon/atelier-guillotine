module.exports = {
  ...
  'about.benefit3.title': 'Un niveau de finition adapté à votre projet',
  ...
  'commissions.ttp.f5':   'Chaque matière à sa technique : cuir, tissu, bois, métal…',
  ...
  'commissions.display.desc':  "Le plus haut niveau de finition que je peux proposer. Je pousse chaque technique aussi loin que la pièce le permet, pour une figurine qui tient l’examen en vitrine.",
  ...
  'commissions.order.step2.text':  "Je reviens vers vous avec un prix par figurine et un délai qui tient compte des commandes déjà en cours. On ajuste tant que le devis ne correspond pas à ce que vous voulez. Il n’y a pas de minimum de commande.",
  ...
  'commissions.order.step6.text':  "Le solde se règle une fois la commande terminée : je n’expédie les figurines qu’après réception du paiement. Si un imprévu vous empêche de payer, prévenez-moi tôt.",
  ...
  'shop.item.cta':         'Acheter ce lot',
  'shop.item.ctaReserved': 'Rejoindre la liste d’attente',
  ...
  'contact.subtitle':           "Décrivez votre projet en quelques lignes, je vous réponds sous 48 h.",
  'contact.name':               'Nom',
  ...
  'contact.shop.title':                 'Une pièce en tête ?',
  'contact.shop.messagePlaceholder':    'Indiquez la pièce qui vous intéresse et vos questions…',
  'contact.courses.title':              'Un cours en tête ?',
  'contact.courses.messagePlaceholder': 'Indiquez la durée souhaitée, le nombre de participants et votre ville…',
  'contact.submit':             'Envoyer le message',
  'contact.sending':            'Envoi…',
  'contact.sent':               'Message envoyé',
  'contact.success':            "Message envoyé ! Je vous réponds sous 48 h.",
  ...
  'faq.q2.answer': "Les délais dépendent de l’ampleur du projet et des commandes déjà en cours. Si vous avez une échéance précise (tournoi ou événement), indiquez-la dès le premier message : je vous confirme ce qui est réalisable.",
