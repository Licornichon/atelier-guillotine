module.exports = {
  ...
  'courses.rates.coverTitle':        'Ce que comprend le tarif',
  'courses.rates.intro':             "Le tarif dépend de la durée et du nombre de participants. Il couvre la séance, pas le matériel : je viens avec mes peintures, on les utilise pendant le cours et je les remporte à la fin. Les figurines, c’est vous qui les fournissez, et vous gardez les deux, la vôtre comme celle que j’ai peinte devant vous. Les montants sont indiqués par personne.",
  ...
  'courses.practical.me.i1':         'Les peintures du cours, prêtées le temps de la séance',
  'courses.practical.me.i2':         'Une fiche des couleurs et des étapes vues ensemble',
  ...
  'courses.practical.double.title':  'La figurine en double',
  'courses.practical.double.text':   'Prévoyez deux fois la même figurine, une pour vous et une pour moi. S’il s’agit d’une unité, un second modèle dans une pose différente convient très bien. On avance ainsi en parallèle sur la même pièce, et vous gardez les deux à la fin.',
