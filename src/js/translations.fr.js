module.exports = {
  ...
  // "from X € per miniature": the amount comes from the price grid in index.pug
  'services.priceFrom': 'à partir de',
  'services.pricePer':  'par figurine',
  'services.tr.name':  'Battle Ready',
  'services.tr.desc':  "La solution la plus rapide pour mettre vos figurines sur la table, avec un rendu propre et lisible en tournoi.",
  'services.tr.f1':    'Sous-couche zénithale',
  'services.tr.f2':    'Application de peinture type Contrast',
  'services.tr.f3':    'Soclage avec pâte texturée',
  'services.tr.cta':   'Commandez une armée sans prise de tête',
  'services.ttp.name':  'Tabletop+',
  'services.ttp.desc': "Une armée avec plus de contraste et de détails pour un rendu qui se démarque, même de près.",
  ...
  'services.ttp.cta':  'Déployez une armée affûtée',
  ...
  'services.display.cta':   'Offrez-vous une pièce à couper le souffle',
