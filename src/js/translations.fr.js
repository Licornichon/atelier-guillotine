module.exports = {
  ...
  'about.award1':                      "🥈🥉 Argent et bronze au concours international de l’AFM Montrouge",
  'about.award2':                      "🎖️ Mention honorable en catégorie Master Fantasy, World Model Expo de Versailles",
  'about.award3':                      "🥇🥈🥉 Or, argent et bronze en concours régionaux",
  'about.instagram':  'Je poste mon travail en cours sur Instagram, <a href="https://www.instagram.com/atelierguillotine/" target="_blank" rel="noopener">@atelierguillotine</a>.',
  ...
  'courses.method.p3':               "Pour réserver, écrivez-moi par le formulaire de contact en indiquant la durée souhaitée, le nombre de participants et votre ville : je vous confirme la date et le devis. Un acompte de 30 % bloque le créneau, le solde se règle le jour du cours, et l’annulation reste gratuite jusqu’à quinze jours avant.",
  ...
  'courses.topics.i3.text':          "ce qu’on pousse et ce qu’on laisse en retrait, pour que le regard se pose là où vous le voulez.",
  'courses.topics.i4.label':         'Couleur',
  'courses.topics.i4.text':          "choisir une palette, les harmonies, et faire varier la teinte à l’intérieur d’une même zone.",
  'courses.topics.i5.label':         'Métaux',
  'courses.topics.i5.text':          "NMM (non metallic metal) et TMM (true metallic metal).",
  'courses.topics.i6.label':         'Peau et visages',
  'courses.topics.i6.text':          "carnations, yeux, et les transitions douces ou abruptes selon le sujet.",
  'courses.topics.i7.label':         'Matières',
  'courses.topics.i7.text':          "cheveux et fourrure, cuir, tissu et drapé, bois, gemmes et cornes : chacune avec ses spécificités.",
  'courses.topics.i8.label':         'Gestes du pinceau',
  'courses.topics.i8.text':          "layering et edge highlight, glacis, lavis, brossage à sec, feathering, dilution...",
