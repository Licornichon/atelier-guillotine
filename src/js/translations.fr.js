module.exports = {
  ...
  'hero.subtitle': 'Service de peinture de figurines :<br>une exécution soignée sans prise de tête.',
  ...
  'commissions.meta.title':       "Prestations | Atelier Guillotine | Peinture de figurines sur commande",
  ...
  'commissions.hero.title':    'Commandes<br>de Peinture',
  'commissions.hero.subtitle': 'Trois niveaux de finition : <br>à vous de trancher.',

  'commissions.title':    'Prestations',
  ...
  'commissions.ttp.f1':   'Éclaircissements renforcés et dégradés simples',
  'commissions.ttp.f2':   'Détails supplémentaires (visages, lentilles, textures, NMM)',
  'commissions.ttp.f3':   'Soclage texturé avec pigments',
  ...
  'commissions.display.f1':    'Éclaircissements avancés, fondus et contrastes poussés',
  'commissions.display.f2':    'Très haut niveau de détail (visages, NMM, OSL, textures)',
  'commissions.display.f3':    'Soclage personnalisé et finitions artistiques',
  'commissions.display.cta':   'Offrez-vous une pièce à couper le souffle',
