module.exports = {
  ...
  'commissions.tr.f2':    "Zenithal priming with an airbrush",
  'commissions.tr.f3':    'Single pass of Contrast-type paint',
  'commissions.tr.f4':    'Textured paste basing',
  'commissions.tr.f5':    'Matt protective varnish',
  ...
  'commissions.ttp.f1':   'Cleaned up, assembled, mould lines removed',
  'commissions.ttp.f2':   "Zenithal priming with an airbrush",
  'commissions.ttp.f3':   "Deeper shading and targeted recess lining",
  'commissions.ttp.f4':   'Two to three highlight passes, simple gradients',
  'commissions.ttp.f5':   'Every detail painted: faces, eyes, lenses, gems',
  'commissions.ttp.f6':   "Each material rendered on its own terms: leather, cloth, wood, metal",
  ...
  'faq.q1.answer': "Every project starts with a discussion. You describe your miniatures and the result you are after, then I send you a detailed quote. Once approved, I handle the painting and keep you updated throughout.",
  ...
  'faq.q3.answer': "Every project is different. A large army in a simple scheme brings the cost per model down, while a detailed or Display-level piece takes far more time at the brush.",
  'faq.q4.title': 'How long does a commission take?',
  'faq.q4.answer': "Turnaround depends on the scale of the project and on my current workload. If you have a deadline (an event or a tournament), tell me up front and I will confirm what is achievable.",
  'faq.q5.title': "Can you match a specific colour scheme or reference?",
  ...
  'faq.q6.answer': 'Yes, I accept commissions worldwide. All return shipments are carefully packaged to ensure safe delivery.',
  'faq.q7.title': 'Is there a minimum order size for commissions?',
  'faq.q7.answer': 'Yes. A minimum of 10 miniatures in total applies for both Battle Ready and Tabletop+ commissions: every model counts, whether it is a trooper or a character. This ensures a consistent workflow and allows efficient batch painting while maintaining quality and fair pricing. Display commissions are exempt: a single piece can be ordered on its own.',
  ...
  'faq.q9.answer': 'Any leftover parts, spare bits, or unused model components may be carefully stored and reused in future conversion projects. This helps reduce waste and feeds other creative work. If you would prefer to have your leftover parts returned, simply let me know when placing your order.',
